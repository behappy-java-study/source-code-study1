package org.xiaowu.txmanager.connection;
...
public class XwConnection implements Connection {

    // getConnection的时候赋值即可使用
    private Connection connection;
    private XwTransaction xwTransaction;

    public XwConnection(Connection connection, XwTransaction xwTransaction) {
        this.connection = connection;
        this.xwTransaction = xwTransaction;
    }
